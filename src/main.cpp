...
shared_ptr<PrzeszkodaProstopadloscian> Pr1 = make_shared<PrzeszkodaProstopadloscian>(1,2*y,1,api);
Pr1->Wznies_Opusc(-(z-5));
Pr1->Obroc(-90);
Pr1->Ruszaj(x-4);
Pr1->Obroc(90);
kolekcja_przeszkod.push_back(Pr1);
shared_ptr<PrzeszkodaProstopadloscian> Pr2 = make_shared<PrzeszkodaProstopadloscian>(10,2,7,api);
Pr2->Obroc(45);
Pr2->Ruszaj(y-4);
Pr2->Obroc(-45);
kolekcja_przeszkod.push_back(Pr2);
shared_ptr<PrzeszkodaProstopadloscian> Pr3 = make_shared<PrzeszkodaProstopadloscian>(1,1,2*z,api);
Pr3->Obroc(90);
Pr3->Ruszaj(x-4);
Pr3->Obroc(90);
Pr3->Ruszaj(y-4);
kolekcja_przeszkod.push_back(Pr3);
shared_ptr<PrzeszkodaProstopadloscian> Pr4 = make_shared<PrzeszkodaProstopadloscian>(2*x,1,1,api);
Pr4->Ruszaj(y-5);
